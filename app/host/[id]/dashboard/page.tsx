                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-[#0F172A] border-t border-white/10 z-20">
                    {activity.status === "OPEN" ? (
                        <button
                            ...
                            className="w-full bg-linear-to-r from-christmas-gold to-yellow-600 text-white font-bold py-3 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isMatching ? (
                                <Loader2 className="w-4 h-4 animate-spin" />
                            ) : (
